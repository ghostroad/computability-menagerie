...
EBIF = menagerie.classMap[u'EBIF']
EBIF.longName = u'effectively bi-immune free'
...
menagerie.addImplication(BIF, EBIF, Obvious())
...
menagerie.addNonimplication(BNDeltaTwo, NotAED, Unjustified())
...
menagerie.addImplication(EBIF, BN1R, DirectJustification(u'Every 1-random is effectively immune, hence effectively bi-immune.'))
menagerie.addNonimplication(EBIF, NotDNC, DirectJustification(u'There is a DNC function that computes no effectively bi-immune set. [Beros 2015]'))
menagerie.addNonimplication(EBIF, HIF, DirectJustification(u'No 1-generic computes an effectively bi-immune set, because being effectively immune is equivalent to being of DNC degree. So there are hyperimmune sets that compute no effectively bi-immune set.'))
...
menagerie.addImplication(NotDNC, EBIF, DirectJustification(u'Every effectively immune set computes a DNC function.'))
...
menagerie.addImplication(CET, EBIF, CompositeJustification(CET.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addImplication(BB1G, EBIF, CompositeJustification(BB1G.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addNonimplication(BN1R, HIF, CompositeJustification(EBIF.implies(BN1R), EBIF.doesNotImply(HIF)))
...
menagerie.setProperty(EBIF, "cardinality", 1, CompositeJustification(BIF.cardinality, BIF.implies(EBIF)))
menagerie.setProperty(EBIF, "pdim", 1, CompositeJustification(BIF.pdim, BIF.implies(EBIF)))
menagerie.addImplication(EBIF, BN2R, CompositeJustification(EBIF.implies(BN1R), BN1R.implies(BN2R)))
menagerie.addImplication(EBIF, NotPA, CompositeJustification(EBIF.implies(BN1R), BN1R.implies(NotPA)))
menagerie.addNonimplication(EBIF, CET, CompositeJustification(CET.implies(NotDNC), EBIF.doesNotImply(NotDNC)))
menagerie.addNonimplication(EBIF, BBmin, CompositeJustification(BIF.implies(EBIF), BIF.doesNotImply(BBmin)))
menagerie.addNonimplication(EBIF, BIF, CompositeJustification(BIF.implies(HIF), EBIF.doesNotImply(HIF)))
menagerie.addNonimplication(EBIF, LowKurtz, CompositeJustification(LowKurtz.implies(HIF), EBIF.doesNotImply(HIF)))
menagerie.addNonimplication(EBIF, BNHIF, CompositeJustification(BIF.implies(EBIF), BIF.doesNotImply(BNHIF)))
menagerie.addNonimplication(EBIF, BNmin, CompositeJustification(BIF.implies(EBIF), BIF.doesNotImply(BNmin)))
menagerie.addNonimplication(EBIF, BB1G, CompositeJustification(BB1G.implies(NotDNC), EBIF.doesNotImply(NotDNC)))
menagerie.addNonimplication(EBIF, NotAED, CompositeJustification(NotDNC.implies(EBIF), NotDNC.doesNotImply(NotAED)))
...
menagerie.addImplication(LowKurtz, EBIF, CompositeJustification(LowKurtz.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addImplication(BB2G, EBIF, CompositeJustification(BB2G.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.setProperty(EBIF, "measure", 0, CompositeJustification(BN1R.measure, EBIF.implies(BN1R)))
menagerie.addImplication(EBIF, NotPAinZP, CompositeJustification(EBIF.implies(BN2R), BN2R.implies(NotPAinZP)))
menagerie.addImplication(EBIF, NotAboveZP, CompositeJustification(EBIF.implies(NotPA), NotPA.implies(NotAboveZP)))
menagerie.addNonimplication(EBIF, ArrayComp, CompositeJustification(ArrayComp.implies(NotAED), EBIF.doesNotImply(NotAED)))
menagerie.addNonimplication(EBIF, BB2R, CompositeJustification(BB2R.implies(BNmin), EBIF.doesNotImply(BNmin)))
menagerie.addNonimplication(EBIF, DeltaTwo, CompositeJustification(EBIF.cardinality, DeltaTwo.cardinality))
menagerie.addNonimplication(EBIF, JumpTraceable, CompositeJustification(JumpTraceable.implies(NotDNC), EBIF.doesNotImply(NotDNC)))
menagerie.addNonimplication(EBIF, LowSchnorr, CompositeJustification(LowSchnorr.implies(HIF), EBIF.doesNotImply(HIF)))
menagerie.addNonimplication(EBIF, OmegaLow, CompositeJustification(OmegaLow.implies(BNHIF), EBIF.doesNotImply(BNHIF)))
menagerie.addNonimplication(EBIF, BNDeltaTwo, CompositeJustification(BB1G.implies(EBIF), BB1G.doesNotImply(BNDeltaTwo)))
menagerie.addNonimplication(EBIF, BNLFO, CompositeJustification(BB1G.implies(EBIF), BB1G.doesNotImply(BNLFO)))
menagerie.addNonimplication(EBIF, NotHigh, CompositeJustification(BB1G.implies(EBIF), BB1G.doesNotImply(NotHigh)))
menagerie.addNonimplication(EBIF, BB2G, CompositeJustification(BB2G.implies(BNHIF), EBIF.doesNotImply(BNHIF)))
...
menagerie.addNonimplication(HIF, EBIF, CompositeJustification(EBIF.implies(NotPA), HIF.doesNotImply(NotPA)))
...
menagerie.addImplication(JumpTraceable, EBIF, CompositeJustification(JumpTraceable.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addImplication(LowSchnorr, EBIF, CompositeJustification(LowSchnorr.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addNonimplication(NotPAinZP, EBIF, CompositeJustification(EBIF.implies(BN2R), NotPAinZP.doesNotImply(BN2R)))
...
menagerie.addNonimplication(OmegaLow, EBIF, CompositeJustification(EBIF.implies(NotPA), OmegaLow.doesNotImply(NotPA)))
...
menagerie.addNonimplication(SuperLow, EBIF, CompositeJustification(EBIF.implies(NotPA), SuperLow.doesNotImply(NotPA)))
...
menagerie.addNonimplication(ArrayComp, EBIF, CompositeJustification(OmegaLow.implies(ArrayComp), OmegaLow.doesNotImply(EBIF)))
...
menagerie.addNonimplication(BB3R, EBIF, CompositeJustification(BB3R.measure, EBIF.measure))
...
menagerie.addNonimplication(BN1G, EBIF, CompositeJustification(EBIF.implies(NotPA), BN1G.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BN2G, EBIF, CompositeJustification(EBIF.implies(NotAboveZP), BN2G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BNDeltaTwo, EBIF, CompositeJustification(EBIF.implies(NotPA), BNDeltaTwo.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BNHIF, EBIF, CompositeJustification(OmegaLow.implies(BNHIF), OmegaLow.doesNotImply(EBIF)))
...
menagerie.addNonimplication(BNLFO, EBIF, CompositeJustification(EBIF.implies(NotPA), BNLFO.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BNSC, EBIF, CompositeJustification(BNSC.measure, EBIF.measure))
...
menagerie.addNonimplication(BNW2G, EBIF, CompositeJustification(EBIF.implies(NotPAinZP), BNW2G.doesNotImply(NotPAinZP)))
...
menagerie.addNonimplication(BOGL1, EBIF, CompositeJustification(OmegaLow.implies(BOGL1), OmegaLow.doesNotImply(EBIF)))
...
menagerie.addNonimplication(DeltaTwo, EBIF, CompositeJustification(EBIF.implies(NotAboveZP), DeltaTwo.doesNotImply(NotAboveZP)))
...
menagerie.setProperty(EBIF, "category", 1, CompositeJustification(BB2G.category, BB2G.implies(EBIF)))
menagerie.addNonimplication(EBIF, BB3R, CompositeJustification(BB3R.implies(BNmin), EBIF.doesNotImply(BNmin)))
menagerie.addNonimplication(EBIF, BN1G, CompositeJustification(BN1G.implies(NotAED), EBIF.doesNotImply(NotAED)))
menagerie.addNonimplication(EBIF, BOGL1, CompositeJustification(LowSchnorr.implies(EBIF), LowSchnorr.doesNotImply(BOGL1)))
menagerie.addNonimplication(EBIF, FSI, CompositeJustification(FSI.implies(NotDNC), EBIF.doesNotImply(NotDNC)))
menagerie.addNonimplication(EBIF, Low, CompositeJustification(EBIF.cardinality, Low.cardinality))
menagerie.addNonimplication(EBIF, Low1Rand, CompositeJustification(Low1Rand.implies(BNHIF), EBIF.doesNotImply(BNHIF)))
menagerie.addNonimplication(EBIF, SuperLow, CompositeJustification(SuperLow.implies(NotAED), EBIF.doesNotImply(NotAED)))
...
menagerie.addImplication(FSI, EBIF, CompositeJustification(FSI.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addNonimplication(Low, EBIF, CompositeJustification(SuperLow.implies(Low), SuperLow.doesNotImply(EBIF)))
...
menagerie.addImplication(Low1Rand, EBIF, CompositeJustification(Low1Rand.implies(NotDNC), NotDNC.implies(EBIF)))
...
menagerie.addNonimplication(NotAboveZP, EBIF, CompositeJustification(OmegaLow.implies(NotAboveZP), OmegaLow.doesNotImply(EBIF)))
...
menagerie.addNonimplication(NotDNCinZP, EBIF, CompositeJustification(EBIF.implies(NotPA), NotDNCinZP.doesNotImply(NotPA)))
...
menagerie.addNonimplication(NotHigh, EBIF, CompositeJustification(EBIF.implies(NotPA), NotHigh.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BB2R, EBIF, CompositeJustification(BB2R.measure, EBIF.measure))
...
menagerie.addNonimplication(BN3G, EBIF, CompositeJustification(EBIF.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BN2R, EBIF, CompositeJustification(EBIF.implies(NotPA), BN2R.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BOGL2, EBIF, CompositeJustification(OmegaLow.implies(BOGL2), OmegaLow.doesNotImply(EBIF)))
...
menagerie.addNonimplication(EBIF, BND1, CompositeJustification(BND1.implies(NotAED), EBIF.doesNotImply(NotAED)))
menagerie.addNonimplication(EBIF, BN3G, CompositeJustification(EBIF.category, BN3G.category))
...
menagerie.addNonimplication(NotPA, EBIF, CompositeJustification(NotPA.measure, EBIF.measure))
...
menagerie.addNonimplication(NotAED, EBIF, CompositeJustification(EBIF.implies(NotPA), NotAED.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BNmin, EBIF, CompositeJustification(BNmin.measure, EBIF.measure))
...
menagerie.addNonimplication(EBIF, BN2G, CompositeJustification(EBIF.category, BN2G.category))
menagerie.addNonimplication(EBIF, BOGL2, CompositeJustification(EBIF.category, BOGL2.category))
...
menagerie.addNonimplication(EBIF, BNW2G, CompositeJustification(EBIF.category, BNW2G.category))

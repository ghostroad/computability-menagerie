...
menagerie.addImplication(ArrayComp, BNW2G, Unjustified())
...
menagerie.setProperty(BIF, "cardinality", 1, Unjustified())
...
menagerie.addImplication(BIF, LowKurtz, DirectJustification(u'Every DNC function computes a bi-immune set [Lewis], as does every hyperimmune degree [Jockusch 1969]. But low for Kurtz random is equivalent to non-DNC and hyperimmune-free [Greenberg and Miller 2009, Lowness for Kurtz randomness]'))
...
menagerie.addNonimplication(BNW2G, NotPAinZP, Unjustified())
...
menagerie.addNonimplication(BOGL1, BNW2G, Unjustified())
...
menagerie.addNonimplication(BN1G, BIF, CompositeJustification(BIF.implies(NotDNC), BN1G.doesNotImply(NotDNC)))
...
menagerie.addImplication(LowKurtz, BNW2G, CompositeJustification(LowKurtz.implies(HIF), HIF.implies(BNW2G)))
...
menagerie.addNonimplication(ArrayComp, BIF, CompositeJustification(BIF.implies(NotDNC), ArrayComp.doesNotImply(NotDNC)))
...
menagerie.addNonimplication(BNW2G, BIF, CompositeJustification(BIF.implies(NotDNC), BNW2G.doesNotImply(NotDNC)))
...
menagerie.addNonimplication(BNW2G, Low1Rand, CompositeJustification(Low1Rand.implies(NotAboveZP), BNW2G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BNW2G, BNSC, CompositeJustification(BNSC.implies(NotAboveZP), BNW2G.doesNotImply(NotAboveZP)))

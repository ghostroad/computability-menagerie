...
menagerie.setProperty(FSI, "cardinality", 1, DirectJustification(u'The class of reals with finite self-information contains a perfect set. [Herbert 2013]'))
...
menagerie.addImplication(Low1Rand, FSI, Unjustified())
...
menagerie.addNonimplication(FSI, BB2G, CompositeJustification(Low1Rand.implies(FSI), Low1Rand.doesNotImply(BB2G)))
menagerie.addNonimplication(FSI, BB2R, CompositeJustification(Low1Rand.implies(FSI), Low1Rand.doesNotImply(BB2R)))
...
menagerie.addNonimplication(FSI, BB3R, CompositeJustification(Low1Rand.implies(FSI), Low1Rand.doesNotImply(BB3R)))
...
menagerie.addNonimplication(FSI, Low1Rand, CompositeJustification(FSI.cardinality, Low1Rand.cardinality))
...
menagerie.addNonimplication(BNDeltaTwo, FSI, CompositeJustification(BNDeltaTwo.category, FSI.category))

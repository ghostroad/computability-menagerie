...
menagerie.addNonimplication(NotPA, BNSC, DirectJustification('There is a shift-complex sequence that is not of PA degree: there is a shift-complex sequence that does not compute any 1-random, and every PA degree computes a 1-random.'))
...
menagerie.addNonimplication(NotAboveZP, BNSC, CompositeJustification(NotPA.implies(NotAboveZP), NotPA.doesNotImply(BNSC)))
...
menagerie.addNonimplication(BN3G, BN1G, CompositeJustification(BN1G.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BN3G, OmegaLow, CompositeJustification(OmegaLow.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BN1R, BB2R, CompositeJustification(BB2R.implies(BNDeltaTwo), BN1R.doesNotImply(BNDeltaTwo)))
...
menagerie.addNonimplication(HIF, BB2G, CompositeJustification(BB2G.implies(NotPA), HIF.doesNotImply(NotPA)))
...
menagerie.addNonimplication(HIF, BBmin, CompositeJustification(BBmin.implies(NotPA), HIF.doesNotImply(NotPA)))
...
menagerie.addNonimplication(NotHigh, BNmin, CompositeJustification(BNmin.implies(NotPA), NotHigh.doesNotImply(NotPA)))
...
menagerie.addNonimplication(NotPAinZP, BNSC, CompositeJustification(BNSC.implies(NotAboveZP), NotPAinZP.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BNSC, BN1G, CompositeJustification(BNSC.measure, BN1G.measure))
menagerie.addNonimplication(BNSC, BN1R, CompositeJustification(BNSC.measure, BN1R.measure))
menagerie.addNonimplication(BNSC, BNLFO, CompositeJustification(BNSC.measure, BNLFO.measure))
...
menagerie.setProperty(NotDNCinZP, "cardinality", 1, CompositeJustification(LowKurtz.cardinality, LowKurtz.implies(NotDNCinZP)))
...
menagerie.addNonimplication(BNSC, HIF, CompositeJustification(BNSC.hdim, HIF.hdim))
menagerie.addNonimplication(BNSC, JumpTraceable, CompositeJustification(BNSC.pdim, JumpTraceable.pdim))
menagerie.addNonimplication(BNSC, Low, CompositeJustification(BNSC.cardinality, Low.cardinality))
...
menagerie.addNonimplication(ArrayComp, BBmin, CompositeJustification(Low1Rand.implies(ArrayComp), Low1Rand.doesNotImply(BBmin)))
...
menagerie.addNonimplication(BN1G, BBmin, CompositeJustification(BBmin.implies(NotPA), BN1G.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BN3G, BBmin, CompositeJustification(BBmin.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
menagerie.addNonimplication(BN3G, BN1R, CompositeJustification(BN1R.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
menagerie.addNonimplication(BN3G, HIF, CompositeJustification(HIF.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
menagerie.addNonimplication(BN3G, Low, CompositeJustification(Low.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
menagerie.addNonimplication(BN3G, Low1Rand, CompositeJustification(Low1Rand.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BN3G, BOGL1, CompositeJustification(BBmin.implies(BN3G), BBmin.doesNotImply(BOGL1)))
menagerie.addNonimplication(BN3G, BB2R, CompositeJustification(BB2R.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BN1R, Low1Rand, CompositeJustification(Low1Rand.implies(BNHIF), BN1R.doesNotImply(BNHIF)))
...
menagerie.addNonimplication(BN2R, BNSC, CompositeJustification(BNSC.implies(NotPA), BN2R.doesNotImply(NotPA)))
menagerie.addNonimplication(BNDeltaTwo, BB2R, CompositeJustification(BB2R.implies(NotPA), BNDeltaTwo.doesNotImply(NotPA)))
menagerie.addNonimplication(BNDeltaTwo, BBmin, CompositeJustification(BBmin.implies(NotPA), BNDeltaTwo.doesNotImply(NotPA)))
...
menagerie.addNonimplication(BNLFO, BBmin, CompositeJustification(BBmin.implies(NotPA), BNLFO.doesNotImply(NotPA)))
...
menagerie.addNonimplication(HIF, Low, CompositeJustification(LowSchnorr.implies(HIF), LowSchnorr.doesNotImply(Low)))
...
menagerie.addNonimplication(HIF, OmegaLow, CompositeJustification(LowSchnorr.implies(HIF), LowSchnorr.doesNotImply(OmegaLow)))
...
menagerie.addNonimplication(NotAboveZP, BBmin, CompositeJustification(Low1Rand.implies(NotAboveZP), Low1Rand.doesNotImply(BBmin)))
...
menagerie.addNonimplication(NotDNCinZP, BBmin, CompositeJustification(BBmin.implies(NotAboveZP), NotDNCinZP.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(NotDNCinZP, DeltaTwo, CompositeJustification(DeltaTwo.implies(BNHIF), NotDNCinZP.doesNotImply(BNHIF)))
...
menagerie.addNonimplication(NotHigh, BB2G, CompositeJustification(BB2G.implies(NotPA), NotHigh.doesNotImply(NotPA)))
menagerie.addNonimplication(NotHigh, BB2R, CompositeJustification(Low.implies(NotHigh), Low.doesNotImply(BB2R)))
menagerie.addNonimplication(NotHigh, BBmin, CompositeJustification(Low.implies(NotHigh), Low.doesNotImply(BBmin)))
...
menagerie.addNonimplication(NotPA, BB1G, CompositeJustification(BB1G.implies(NotDNC), NotPA.doesNotImply(NotDNC)))
menagerie.addNonimplication(NotPA, BB3R, CompositeJustification(BNmin.implies(NotPA), BNmin.doesNotImply(BB3R)))
menagerie.addNonimplication(NotPA, BN1G, CompositeJustification(NotPA.measure, BN1G.measure))
...
menagerie.addNonimplication(NotPA, Low1Rand, CompositeJustification(BNmin.implies(NotPA), BNmin.doesNotImply(Low1Rand)))
...
menagerie.addNonimplication(BNSC, BB2G, CompositeJustification(BNSC.measure, BB2G.measure))
menagerie.addNonimplication(BNSC, BBmin, CompositeJustification(BNSC.measure, BBmin.measure))
...
menagerie.addNonimplication(BNLFO, Low1Rand, CompositeJustification(BNLFO.hdim, Low1Rand.hdim))
...
menagerie.addNonimplication(BNSC, BB1G, CompositeJustification(BNSC.hdim, BB1G.hdim))
menagerie.addNonimplication(BNSC, Low1Rand, CompositeJustification(BNSC.pdim, Low1Rand.pdim))
menagerie.addNonimplication(BNSC, LowKurtz, CompositeJustification(BNSC.hdim, LowKurtz.hdim))
menagerie.addNonimplication(BNSC, SuperLow, CompositeJustification(BNSC.cardinality, SuperLow.cardinality))
...
menagerie.addNonimplication(BN3G, JumpTraceable, CompositeJustification(JumpTraceable.implies(BOGL1), BN3G.doesNotImply(BOGL1)))
menagerie.addNonimplication(BN3G, LowKurtz, CompositeJustification(LowKurtz.implies(NotAboveZP), BN3G.doesNotImply(NotAboveZP)))
...
menagerie.addNonimplication(BN2R, BBmin, CompositeJustification(BBmin.implies(NotAboveZP), BN2R.doesNotImply(NotAboveZP)))
menagerie.addNonimplication(BN2R, BN2G, CompositeJustification(BN2R.category, BN2G.category))
menagerie.addNonimplication(BN2R, Low1Rand, CompositeJustification(Low1Rand.implies(BNHIF), BN2R.doesNotImply(BNHIF)))
...
menagerie.addNonimplication(BNDeltaTwo, Low1Rand, CompositeJustification(Low1Rand.implies(NotHigh), BNDeltaTwo.doesNotImply(NotHigh)))
menagerie.addNonimplication(BNDeltaTwo, OmegaLow, CompositeJustification(LowSchnorr.implies(BNDeltaTwo), LowSchnorr.doesNotImply(OmegaLow)))
...
menagerie.addNonimplication(BNLFO, OmegaLow, CompositeJustification(LowSchnorr.implies(BNLFO), LowSchnorr.doesNotImply(OmegaLow)))
...
menagerie.addNonimplication(BOGL2, BBmin, CompositeJustification(Low.implies(BOGL2), Low.doesNotImply(BBmin)))
...
menagerie.addNonimplication(HIF, Low1Rand, CompositeJustification(HIF.pdim, Low1Rand.pdim))
menagerie.addNonimplication(HIF, SuperLow, CompositeJustification(LowSchnorr.implies(HIF), LowSchnorr.doesNotImply(SuperLow)))
menagerie.addImplication(Low1Rand, BN2R, CompositeJustification(Low1Rand.implies(NotDNC), NotDNC.implies(BN2R)))
menagerie.addImplication(Low1Rand, NotPA, CompositeJustification(Low1Rand.implies(NotDNC), NotDNC.implies(NotPA)))
...
menagerie.addNonimplication(NotAboveZP, Low1Rand, CompositeJustification(Low1Rand.implies(BNHIF), NotAboveZP.doesNotImply(BNHIF)))
...
menagerie.addNonimplication(NotHigh, BB3R, CompositeJustification(Low.implies(NotHigh), Low.doesNotImply(BB3R)))
menagerie.addNonimplication(NotHigh, LowKurtz, CompositeJustification(Low.implies(NotHigh), Low.doesNotImply(LowKurtz)))
menagerie.addNonimplication(NotPA, BBmin, CompositeJustification(NotPA.measure, BBmin.measure))
...
menagerie.addNonimplication(OmegaLow, Low1Rand, CompositeJustification(Low1Rand.implies(NotHigh), OmegaLow.doesNotImply(NotHigh)))
...
menagerie.addNonimplication(BN3G, LowSchnorr, CompositeJustification(BN3G.pdim, LowSchnorr.pdim))
menagerie.addNonimplication(BN1R, BBmin, CompositeJustification(Low1Rand.implies(BN1R), Low1Rand.doesNotImply(BBmin)))
